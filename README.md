...
| # | Section | Description |
|---|---|---|
| 01 | [Domain Controller Setup](01-domain-controller-setup/README.md) | Built and configured DC01 with AD DS, DNS, DHCP, and NAT routing |
| 02 | [Client Workstation Setup](02-client-workstation-setup/README.md) | Configured Client01 and joined it to the domain |
| 03 | [Active Directory Administration](03-active-directory-administration/README.md) | Created OUs, users, groups, reset passwords, disabled and unlocked accounts |
| 04 | [Group Policy](04-group-policy/README.md) | Configured password policy, account lockout, and drive mapping GPOs |
| 05 | [PowerShell Administration](05-powershell-administration/README.md) | Managed AD users and groups entirely from the command line |
| 06 | [Troubleshooting](06-troubleshooting/README.md) | Diagnosed and resolved five real-world issues encountered during the build |
---
